                ...
                <div className="mobile-menu">
                    ...
                    <nav className="menu-box mCustomScrollbar">
                            ...
                            <div className="nav-logo">
                                <a href="#.">
                                    <img src="assets/images/KBMC-logo-1-edited2.png" alt="" title="" />
                                </a>
                            </div>

                            <div className="collapse navbar-collapse show clearfix" id="navbarSupportedContent">
                                <ul className="navigation clearfix">
                                    <li className="current"><a href="index.php">Home</a></li>
                                    ...
                                    <li className="dropdown">
                                        ...
                                        <ul>
                                            <li><a href="assets/documents/KBMC CIRCULATION A3 COLOR-Brown-24 (1).pdf" target="_blank">Areas</a></li>
                                            <li><a href="property-holder.php">Property Holder</a></li>
                                            <li><a href="properties_milkat.php">Municipal Properties</a></li>
                                            <li><a href="schools.php">Schools</a></li>
                                            <li><a href="gardens.php">Gardens</a></li>
                                            <li><a href="electric.php">Electric</a></li>
                                            <li><a href="roads.php">Roads</a></li>
                            ...
                            <div className="social-links">
                                <ul className="clearfix">
                                    ...
                                    <li><a href="https://twitter.com/home" target="_blank"><span className="fab fa-twitter"></span></a></li>
                                    <li><a href="https://www.facebook.com/profile.php?id=100015538206978&amp;mibextid=ZbWKwL" target="_blank"><span className="fab fa-facebook"></span></a></li>
                                </ul>
                            </div>
