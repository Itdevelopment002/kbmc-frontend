...
import img1 from '../../assets/images/no-profile-img.jpg'
...
const ElectedWing = () => {
  return (
    ...
    <br/>
    <br/>
    <section class="team-section sec-pad member-section">
            <div class="auto-container">
                <div class="row clearfix">
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block mb-4">
                        <div class="team-block-one wow fadeInUp animated" data-wow-delay="00ms" data-wow-duration="1500ms" style={{visibility: 'visible'}}>
                            <div class="inner-box">
                                ...
                                <h3><a href="#.">Correspondent Name</a></h3>
                                <span class="designation">Ward No. 01</span>
                                <p><a href="#."><i class="ri-calendar-2-line"></i> 01.01.2020 to 31.05.2022</a></p>
                                <p><a href="#."><i class="ri-smartphone-line"></i> +9988776655</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 col-sm-12 team-block mb-4">
