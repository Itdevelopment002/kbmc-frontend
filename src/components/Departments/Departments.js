...
const Departments = () => {
  return (
    <div>
        ...
        <div class="bg-layer" style={{ backgroundImage: `url(${innerBanner})` }}></div>
        <div class="line-box">
            ...
            <div class="row clearfix">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 departments-block">
                    <div class="departments-block-two">
                        <div class="inner-box">
                            <div class="content-box">
                                <h3><a href="/tax-department">Tax Department</a></h3>
                                <p>Name of HOD : Pratiksha Sawant</p>
                                <div class="link-box">
                                    <a href="/tax-department"><span>Read More</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 departments-block">
                    <div class="departments-block-two">
                        <div class="inner-box">
                            <div class="content-box">
                                <h3><a href="/town-planning">Town Planning</a></h3>
                                <p>Name of HOD : Amar Gadge</p>
                                <div class="link-box">
                                    <a href="/town-planning"><span>Read More</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 departments-block">
                    <div class="departments-block-two">
                        <div class="inner-box">
                            <div class="content-box">
                                <h3><a href="/wcd">WCD (Women and Child Development)</a></h3>
                                <p>Name of HOD : Shrikant Nikule</p>
                                <div class="link-box">
                                    <a href="/wcd"><span>Read More</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 departments-block">
                    <div class="departments-block-two">
                        <div class="inner-box">
                            <div class="content-box">
                                <h3><a href="/#.">Security Department</a></h3>
                                <p>Name of HOD : Abhijit Tamhane</p>
                                <div class="link-box">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 departments-block">
                    <div class="departments-block-two">
                        <div class="inner-box">
                            <div class="content-box">
                                <h3><a href="/#.">Store & Records Department</a></h3>
                                <p>Name of HOD : Megha Kadam</p>
                                <div class="link-box">
                                    <a href="/#."><span>Read More</span></a>
                                </div>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 departments-block">
                    <div class="departments-block-two">
                        <div class="inner-box">
                            <div class="content-box">
                                <h3><a href="/#."> Marriage Registration</a></h3>
                                <p>Name of HOD : Dr. Rajesh Ankush</p>
                                <div class="link-box">
                                    <a href="/#."><span>Read More</span></a>
                                </div>
